...
const Video = ({id:{videoId}, snippet,}) => {
 ...
 const demoVideoUrl="/video/GDa8kZLNhJ4";
  return (
    <div className="w-64 border-white rounded-lg m-5 h-84" >
      ...
      <Image
        ...
        alt={snippet.title}
        />
      <h2>{snippet.title||"Build and Deploy 5 JavaScript & React API Projects in 10 Hours - Full Course | RapidAPI'"}</h2>
